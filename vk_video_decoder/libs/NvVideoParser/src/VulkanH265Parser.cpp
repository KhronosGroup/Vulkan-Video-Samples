...
void VulkanH265Decoder::seq_parameter_set_rbsp()
{
    ...
    if (!MultiLayerExtSpsFlag) {
        sps->flags.sps_temporal_id_nesting_flag = u(1) & 0x1;
    ...
    if (MultiLayerExtSpsFlag) {
        ...
        if (sps->chroma_format_idc == 3) {
            sps->flags.separate_colour_plane_flag = u(1) & 0x1;
        }
    ...
    sps->flags.amp_enabled_flag = u(1) & 0x1;
    sps->flags.sample_adaptive_offset_enabled_flag = u(1) & 0x1;
    sps->flags.pcm_enabled_flag = u(1) & 0x1;
    if (sps->flags.pcm_enabled_flag) {
        ...
        sps->flags.pcm_loop_filter_disabled_flag = u(1) & 0x1;
    ...
    sps->flags.long_term_ref_pics_present_flag = u(1) & 0x1;
    ...
    sps->flags.sps_temporal_mvp_enabled_flag = u(1) & 0x1;
    sps->flags.strong_intra_smoothing_enabled_flag = u(1) & 0x1;
    sps->flags.vui_parameters_present_flag = u(1) & 0x1;
    if (sps->flags.vui_parameters_present_flag) { // vui_parameters_present_flag

        vui_parameters(sps, sps->sps_max_sub_layers_minus1);
    }
    sps->flags.sps_extension_present_flag = u(1) & 0x1;
    if (sps->flags.sps_extension_present_flag) { // sps_extension_present_flag

        sps->flags.sps_range_extension_flag = u(1) & 0x1;
        bool sps_multilayer_extension_flag = u(1);
        u(6); // sps_extension_6bits
        if (sps->flags.sps_range_extension_flag) {
            sps->flags.transform_skip_rotation_enabled_flag = u(1) & 0x1;
            sps->flags.transform_skip_context_enabled_flag = u(1) & 0x1;
            sps->flags.implicit_rdpcm_enabled_flag = u(1) & 0x1;
            sps->flags.explicit_rdpcm_enabled_flag = u(1) & 0x1;
            sps->flags.extended_precision_processing_flag = u(1) & 0x1;
            sps->flags.intra_smoothing_disabled_flag = u(1) & 0x1;
            sps->flags.high_precision_offsets_enabled_flag = u(1) & 0x1;
            sps->flags.persistent_rice_adaptation_enabled_flag = u(1) & 0x1;
            sps->flags.cabac_bypass_alignment_enabled_flag = u(1) & 0x1;
        }
...
void VulkanH265Decoder::pic_parameter_set_rbsp()
{
    ...
    pps->flags.dependent_slice_segments_enabled_flag = u(1) & 0x1; // name differs from spec
    pps->flags.output_flag_present_flag = u(1) & 0x1;
    pps->num_extra_slice_header_bits = (uint8_t)u(3);
    pps->flags.sign_data_hiding_enabled_flag = u(1) & 0x1;
    pps->flags.cabac_init_present_flag = u(1) & 0x1;
    ...
    pps->flags.constrained_intra_pred_flag = u(1) & 0x1;
    pps->flags.transform_skip_enabled_flag = u(1) & 0x1;
    pps->flags.cu_qp_delta_enabled_flag = u(1) & 0x1;
    ...
    pps->flags.pps_slice_chroma_qp_offsets_present_flag = u(1) & 0x1; // name differs from spec
    pps->flags.weighted_pred_flag = u(1) & 0x1;
    pps->flags.weighted_bipred_flag = u(1) & 0x1;
    pps->flags.transquant_bypass_enabled_flag = u(1) & 0x1;
    pps->flags.tiles_enabled_flag = u(1) & 0x1;
    pps->flags.entropy_coding_sync_enabled_flag = u(1) & 0x1;
    ...
    if (pps->flags.tiles_enabled_flag)
    {
        ...
        pps->flags.uniform_spacing_flag = u(1) & 0x1;
        ...
        pps->flags.loop_filter_across_tiles_enabled_flag = u(1) & 0x1;
    }
    pps->flags.pps_loop_filter_across_slices_enabled_flag = u(1) & 0x1;
    pps->flags.deblocking_filter_control_present_flag = u(1) & 0x1;
    if (pps->flags.deblocking_filter_control_present_flag)
    {
        pps->flags.deblocking_filter_override_enabled_flag = u(1) & 0x1;
        pps->flags.pps_deblocking_filter_disabled_flag = u(1) & 0x1; // slice_disable_deblocking_filter_flag LoopFilterDisable
    ...
    pps->flags.pps_scaling_list_data_present_flag = u(1) & 0x1;
    if (pps->flags.pps_scaling_list_data_present_flag) {
        scaling_list_data(&pps->pps_scaling_list);
    }
    pps->flags.lists_modification_present_flag = u(1) & 0x1;
    ...
    pps->flags.slice_segment_header_extension_present_flag = u(1) & 0x1;
    pps->flags.pps_extension_present_flag = u(1) & 0x1;
    if (pps->flags.pps_extension_present_flag) {
        pps->flags.pps_range_extension_flag = u(1) & 0x1;
        ...
        if (pps->flags.pps_range_extension_flag) {
            ...
            pps->flags.cross_component_prediction_enabled_flag = u(1) & 0x1;
            pps->flags.chroma_qp_offset_list_enabled_flag = u(1) & 0x1;
...
void VulkanH265Decoder::video_parameter_set_rbsp()
{
    ...
    vps->privFlags.vps_base_layer_internal_flag  = u(1) & 0x1;
    vps->privFlags.vps_base_layer_available_flag = u(1) & 0x1;
    uint32_t tmp = u(6);
    vps->vps_max_layers_minus1         = std::min<int32_t>(tmp, (uint32_t)(MAX_NUM_LAYER_IDS - 2));
    vps->vps_max_sub_layers_minus1     = (uint8_t)u(3);
    vps->flags.vps_temporal_id_nesting_flag  = u(1) & 0x1;
    ...
    vps->flags.vps_sub_layer_ordering_info_present_flag =  u(1) & 0x1;
    ...
    // HRD related
    vps->flags.vps_timing_info_present_flag = u(1) & 0x1;
    if (vps->flags.vps_timing_info_present_flag != 0)
    {
        ...
        vps->flags.vps_poc_proportional_to_timing_flag = u(1) & 0x1;
    ...
    {
        vps->privFlags.vps_extension_flag = u(1) & 0x1;
...
void VulkanH265Decoder::video_parameter_set_rbspExtension(hevc_video_param_s *pVideoParamSet)
{
    ...
    pVideoParamSet->privFlags.splitting_flag = u(1) & 0x1;
    ...
    pVideoParamSet->privFlags.vps_nuh_layer_id_present_flag = u(1) & 0x1;
    ...
    pVideoParamSet->privFlags.vps_sub_layers_max_minus1_present_flag = u(1) & 0x1;
    ...
    pVideoParamSet->privFlags.max_tid_ref_present_flag = u(1) & 0x1;
    ...
    pVideoParamSet->privFlags.default_ref_layers_active_flag = u(1) & 0x1;
    ...
    {
        pVideoParamSet->privFlags.rep_format_idx_present_flag = u(1) & 0x1;
    ...
    pVideoParamSet->privFlags.max_one_active_ref_layer_flag = u(1) & 0x1;
    pVideoParamSet->privFlags.vps_poc_lsb_aligned_flag = u(1) & 0x1;
...
void VulkanH265Decoder::vui_parameters(hevc_seq_param_s *sps, int sps_max_sub_layers_minus1)
{
    ...
    vui->flags.aspect_ratio_info_present_flag = u(1) & 0x1;
    ...
    vui->flags.overscan_info_present_flag = u(1) & 0x1;
    if (vui->flags.overscan_info_present_flag) {
        vui->flags.overscan_appropriate_flag = u(1) & 0x1;
    }
    vui->flags.video_signal_type_present_flag = u(1) & 0x1;
    if (vui->flags.video_signal_type_present_flag)
    {
        vui->video_format = (uint8_t)u(3);
        vui->flags.video_full_range_flag = u(1) & 0x1;
        vui->flags.colour_description_present_flag = u(1) & 0x1;
    ...
    vui->flags.chroma_loc_info_present_flag = u(1) & 0x1;
    ...
    vui->flags.neutral_chroma_indication_flag = u(1) & 0x1;
    vui->flags.field_seq_flag = u(1) & 0x1;
    vui->flags.frame_field_info_present_flag = u(1) & 0x1;
    vui->flags.default_display_window_flag = u(1) & 0x1;
    ...
    vui->flags.bitstream_restriction_flag = u(1) & 0x1;
    if (vui->flags.bitstream_restriction_flag) {
        vui->flags.tiles_fixed_structure_flag = u(1) & 0x1;
        vui->flags.motion_vectors_over_pic_boundaries_flag = u(1) & 0x1;
        vui->flags.restricted_ref_pic_lists_flag = u(1) & 0x1;
...
void VulkanH265Decoder::hrd_parameters(hevc_video_hrd_param_s* pStdHrdParameters, bool commonInfPresentFlag, uint8_t maxNumSubLayersMinus1)
{
    ...
    {
        pStdHrdParameters->flags.nal_hrd_parameters_present_flag = u(1) & 0x1;
        pStdHrdParameters->flags.vcl_hrd_parameters_present_flag = u(1) & 0x1;
        if (pStdHrdParameters->flags.nal_hrd_parameters_present_flag || pStdHrdParameters->flags.vcl_hrd_parameters_present_flag)
        {
            pStdHrdParameters->flags.sub_pic_hrd_params_present_flag = u(1) & 0x1;
            if (pStdHrdParameters->flags.sub_pic_hrd_params_present_flag)
            {
                ...
                pStdHrdParameters->flags.sub_pic_cpb_params_in_pic_timing_sei_flag = u(1) & 0x1;
