                                                ...
                                                VkParserDecodePictureInfo* pDecodePictureInfo)
{
    ...
    if (m_enableDecodeComputeFilter) {
        ...
        int32_t index = m_videoFrameBuffer->GetCurrentImageResourceByIndex((uint8_t)(currPicIdx), m_imageSpecsIndex.filterIn, inputImageView);
        ...
        index = m_videoFrameBuffer->GetCurrentImageResourceByIndex((uint8_t)(currPicIdx), m_imageSpecsIndex.filterOut, outputImageView);
