...
class VulkanVideoTestFramework:  # pylint: disable=too-many-instance-attributes
    ...
    def print_summary(self, encode_results: Optional[List] = None,
        ...
        if self.ignore_skip_list:
            ...
            total_including_skipped = total_tests + self._count_non_skipped_tests()
        else:
        ...
        effective_total = total_tests - total_not_supported
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--skip-list",
        help="Path to custom skip list JSON file (default: skipped_samples.json)")
    parser.add_argument(
